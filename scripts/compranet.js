...
var db = pgp( 'postgres://postgres:b110843@localhost/edca1' );
...
converter.on("record_parsed", function (jsonObj) {
    ...
    db.tx(function (t) {
        ...
        return t.one("insert into ContractingProcess (ocid, fecha_creacion, hora_creacion) values ($1, current_date, current_time) returning id",[
            jsonObj.SIGLAS + jsonObj.CODIGO_EXPEDIENTE
...
//read from file
require("fs").createReadStream("./input/datos.csv").pipe(converter);